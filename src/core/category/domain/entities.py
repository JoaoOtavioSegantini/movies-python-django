...
from core._seedworker.domain.entities import Entity
from core._seedworker.domain.exceptions import EntityValidationException
...
class Category(Entity):
    ...
    created_at: Optional[datetime.datetime] = field(
        default_factory=lambda: datetime.datetime.now(datetime.timezone.utc)  # pylint: disable=unnecessary-lambda
    )
