...
import uuid
from core._seedworker.domain.exceptions import InvalidUuidException

from core._seedworker.domain.value_objects import UniqueEntityId, ValueObject
...
class TestUniqueEntityIdUnit(unittest.TestCase):
    ...
    def test_convert_to_string(self):
        value_object = UniqueEntityId()
        self.assertEqual(value_object.id, str(value_object.id))
